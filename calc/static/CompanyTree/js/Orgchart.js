...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : e((t.d3 = t.d3 || {}), t.d3, t.d3, t.d3, t.d3, t.d3, t.d3);
  ...
  (t.OrgChart = class {
    constructor() {
      const t = {
        ...
        nodeContent: (t) =>
          `<div style="padding:5px;font-size:10px;">Sample Node(id=${t.id}), override using <br/> \n            <code>chart.nodeContent({data}=>{ <br/>\n             &nbsp;&nbsp;&nbsp;&nbsp;return '' // Custom HTML <br/>\n             })</code>\n             <br/> \n             Or check different <a href="https://github.com/bumbeishvili/org-chart#jump-to-examples" target="_blank">layout examples</a>\n             </div>`,
        ...
        pagingButton: (t, e, n, a) => {
          const i = a.pagingStep(t.parent),
            o = t.parent.data._pagingStep,
            r = t.parent.data._directSubordinatesPaging - o;
          return `\n                   <div style="margin-top:90px;">\n                      <div style="display:flex;width:170px;border-radius:20px;padding:5px 15px; padding-bottom:4px;;background-color:#E5E9F2">\n                      <div><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\n                      <path d="M5.59 7.41L10.18 12L5.59 16.59L7 18L13 12L7 6L5.59 7.41ZM16 6H18V18H16V6Z" fill="#716E7B" stroke="#716E7B"/>\n                      </svg>\n                      </div><div style="line-height:2"> Show next ${Math.min(
            r,
            i
          )}  nodes </div></div>\n                   </div>\n                `;
        },
        nodeUpdate: function (t, e, n) {
          d.select(this)
            .select(".node-rect")
            .attr("stroke", (t) =>
              t.data._highlighted || t.data._upToTheRootHighlighted
                ? "#E27396"
                : "none"
            )
            .attr(
              "stroke-width",
              t.data._highlighted || t.data._upToTheRootHighlighted ? 10 : 1
            );
        },
        linkUpdate: function (t, e, n) {
          d
            .select(this)
            .attr("stroke", (t) =>
              t.data._upToTheRootHighlighted ? "#E27396" : "#E4E2E9"
            )
            .attr("stroke-width", (t) =>
              t.data._upToTheRootHighlighted ? 5 : 1
            ),
        ...
        hdiagonal: function (t, e, n) {
          const a = t.x,
            ...
            o = e.x,
            r = e.y;
          let d = n && null != n.x ? n.x : a,
            s = n && null != n.y ? n.y : i,
            l = o - a < 0 ? -1 : 1,
            c = r - i < 0 ? -1 : 1,
            h = Math.abs(o - a) / 2 < 35 ? Math.abs(o - a) / 2 : 35;
          h = Math.abs(r - i) / 2 < h ? Math.abs(r - i) / 2 : h;
          Math.abs(r - i);
        ...
        defs: function (t, e) {
          return `<defs>\n                    ${e
            .map((e) => {
              const n = this.getTextWidth(e.label, {
                ctx: t.ctx,
                fontSize: 2,
              ...
              return `\n                       <marker id="${
                ...
                e._source.x < e._target.x ? -7 : 7
              }" refY="5" markerWidth="500"  markerHeight="500"  orient="${
                e._source.x < e._target.x ? "auto" : "auto-start-reverse"
              }" >\n                       <rect rx=0.5 width=${
                e.label ? n + 3 : 0
        ...
        layoutBindings: {
          left: {
            ...
            nodeUpdateTransform: ({ x: t, y: e, width: n, height: a }) =>
              `translate(${t},${e - a / 2})`,
          },
          top: {
      ...
      (this.getChartState = () => t),
        Object.keys(t).forEach((e) => {
          this[e] = function (n) {
            return arguments.length ? ((t[e] = n), this) : t[e];
          };
        }),
    ...
    initializeEnterExitUpdatePattern() {
      d.selection.prototype.patternify = function (t) {
        var e = t.selector,
          n = t.tag,
          a = t.data || [e],
          i = this.selectAll("." + e).data(a, (t, e) =>
            "object" == typeof t && t.id ? t.id : e
          );
        return (
          i.exit().remove(),
          (i = i.enter().append(n).merge(i)).attr("class", e),
          i
        );
      };
    }
    ...
    render() {
      ...
      if (!t.data || 0 == t.data.length)
        return (
          ...
          t.container &&
            (e.select(t.container).select(".nodes-wrapper").remove(),
      ...
      if (
        ((t.calc = i),
        (i.centerX = i.chartWidth / 2),
        (i.centerY = i.chartHeight / 2),
        t.firstDraw)
      ) {
        const e = { zoom: null };
        (e.zoom = t
          .createZoom()
          .clickDistance(10)
          .on("start", (e, n) => t.onZoomStart(e))
          .on("end", (e, n) => t.onZoomEnd(e))
          .on("zoom", (e, n) => {
            t.onZoom(e), this.zoomed(e, n);
          })
      ...
      (t.flexTreeLayout = o
        ...
        .spacing((e, n) =>
          e.parent == n.parent ? 0 : t.neighbourMargin(e, n)
        )),
        this.setLayouts({ expandNodesFirst: !1 });
      const r = n
      ...
      t.firstDraw &&
        r.call(t.zoomBehavior).on("dblclick.zoom", null).attr("cursor", "move"),
        (t.svg = r);
      const s = r.patternify({ tag: "g", selector: "chart" });
      return (
        (t.centerG = s.patternify({ tag: "g", selector: "center-group" })),
        (t.linksWrapper = t.centerG.patternify({
          tag: "g",
          selector: "links-wrapper",
        })),
        (t.nodesWrapper = t.centerG.patternify({
          tag: "g",
          selector: "nodes-wrapper",
        })),
        (t.connectionsWrapper = t.centerG.patternify({
          tag: "g",
          selector: "connections-wrapper",
        })),
        (t.defsWrapper = r.patternify({ tag: "g", selector: "defs-wrapper" })),
        t.firstDraw &&
          t.centerG.attr("transform", () =>
            t.layoutBindings[t.layout].centerTransform({
              centerX: i.centerX,
              centerY: i.centerY,
        ...
        (t.chart = s),
        this.update(t.root),
        d.select(window).on(`resize.${t.id}`, () => {
    ...
    addNode(t) {
      const e = this.getChartState(),
        ...
        a = n.filter(
          ({ data: n }) => e.nodeId(n).toString() === e.nodeId(t).toString()
        )[0],
        i = n.filter(
          ({ data: n }) =>
            e.nodeId(n).toString() === e.parentNodeId(t).toString()
        )[0];
      return a
        ? (console.log(
            `ORG CHART - ADD - Node with id "${e.nodeId(
              t
        ...
        ? (t._centered && !t._expanded && (t._expanded = !0),
          ...
          this)
        : (console.log(
            `ORG CHART - ADD - Parent node with id "${e.parentNodeId(
              t
    ...
    removeNode(t) {
      const e = this.getChartState(),
        n = e
          .generateRoot(e.data)
          .descendants()
          .filter(({ data: n }) => e.nodeId(n) == t)[0];
      if (!n)
        return (
          console.log(
            `ORG CHART - REMOVE - Node with id "${t}" not found in the tree`
          ),
          this
        );
      if (
        ...
        t.eachBefore((t) => {
          if (t.children && t.children.length > 1) {
            ...
            const a = d.max(
                ...
                e.layoutBindings[e.layout].compactDimension.sizeColumn
              ),
              i = d.max(
                n.filter((t) => !t.compactEven),
                e.layoutBindings[e.layout].compactDimension.sizeColumn
              ...
              r = this.groupBy(
                ...
                (t) =>
                  d.max(
                    t,
                    (t) =>
                      e.layoutBindings[e.layout].compactDimension.sizeRow(t) +
                      e.compactMarginBetween(t)
                  )
              ),
              s = d.sum(r.map((t) => t[1]));
            n.forEach((t) => {
              (t.firstCompactNode = n[0]),
                t.firstCompact
                  ? (t.flexCompactDim = [
                      o + e.compactMarginPair(t),
                      s - e.compactMarginBetween(t),
                    ])
                  : (t.flexCompactDim = [0, 0]);
            }),
              (t.flexCompactDim = null);
          }
        });
          ...
          n.forEach((t, n, i) => {
            0 == n && (a.x -= a.flexCompactDim[0] / 2),
              n & ((n % 2) - 1)
                ? (t.x =
                    a.x +
                    0.25 * a.flexCompactDim[0] -
                    e.compactMarginPair(t) / 4)
                : n &&
                  (t.x =
                    a.x +
                    0.75 * a.flexCompactDim[0] +
                    e.compactMarginPair(t) / 4);
          });
          const i = a.x + 0.5 * a.flexCompactDim[0];
          a.x = a.x + 0.25 * a.flexCompactDim[0] - e.compactMarginPair(a) / 4;
          const o = t.x - i;
          Math.abs(o) < 10 && n.forEach((t) => (t.x += o));
          const r = this.groupBy(
              n,
              (t) => t.row,
              (t) =>
                d.max(t, (t) =>
    ...
    update({ x0: t, y0: e, x: n = 0, y: a = 0, width: i, height: o }) {
      ...
      const f = r.linksWrapper
          .selectAll("path.link")
          .data(c, (t) => r.nodeId(t.data)),
        y = f
          .enter()
          .insert("path", "g")
          .attr("class", "link")
          .attr("d", (n) => {
            const a = {
              x: r.layoutBindings[r.layout].linkJoinX({
                x: t,
                y: e,
                width: i,
                height: o,
              }),
              y: r.layoutBindings[r.layout].linkJoinY({
                x: t,
                y: e,
                width: i,
                height: o,
            ...
            const e =
              ...
              a =
                r.compact && t.flexCompactDim
                  ...
                  : e;
            return r.layoutBindings[r.layout].diagonal(e, n, a, {
              sy: r.linkYOffset,
            });
          });
      f.exit()
        ...
        .attr("d", (t) => {
          ...
          return r.layoutBindings[r.layout].diagonal(e, e, null, {
            sy: r.linkYOffset,
          });
        })
        .remove();
      const x = r.connectionsWrapper.selectAll("path.connection").data(u),
        C = x
          ...
          .attr("d", (n) => {
            ...
            return r.layoutBindings[r.layout].diagonal(a, a, null, {
              sy: r.linkYOffset,
            });
          })
          .merge(x);
        ...
        C.transition()
          ...
          .attr("d", (t) => {
            const e = r.layoutBindings[r.layout].linkX({
              ...
              n = r.layoutBindings[r.layout].linkY({
                x: t._source.x,
                y: t._source.y,
                width: t._source.width,
                height: t._source.height,
              }),
              a = r.layoutBindings[r.layout].linkJoinX({
                x: t._target.x,
                y: t._target.y,
                width: t._target.width,
                height: t._target.height,
              }),
              i = r.layoutBindings[r.layout].linkJoinY({
                x: t._target.x,
                y: t._target.y,
                width: t._target.width,
                height: t._target.height,
              });
            return r.linkGroupArc({
              source: { x: e, y: n },
              target: { x: a, y: i },
            });
          }),
      ...
      const w = r.nodesWrapper
          .selectAll("g.node")
          .data(l, ({ data: t }) => r.nodeId(t)),
        v = w
          .enter()
          .append("g")
          .attr("class", "node")
          .attr("transform", (n) => {
            if (n == r.root) return `translate(${t},${e})`;
            return `translate(${r.layoutBindings[r.layout].nodeJoinX({
              x: t,
              y: e,
              width: i,
              height: o,
            })},${r.layoutBindings[r.layout].nodeJoinY({
              x: t,
              y: e,
              width: i,
              height: o,
          ...
          .on("keydown.node", (t, e) => {
            ...
            if ("Enter" === t.key || " " === t.key || "Spacebar" === t.key) {
              if (
                ...
                return;
              if ([...t.srcElement.classList].includes("paging-button-wrapper"))
                return void this.loadPagingNodes(e);
      ...
      k
        ...
        .attr("transform", ({ x: t, y: e, width: n, height: a }) =>
          r.layoutBindings[r.layout].nodeUpdateTransform({
            x: t,
            y: e,
            width: n,
            height: a,
        ...
        k
          ...
          .attr(
            "transform",
            ({ data: t, width: e, height: n }) =>
              `translate(${r.layoutBindings[r.layout].buttonX({
                width: e,
                height: n,
              })},${r.layoutBindings[r.layout].buttonY({
                width: e,
                height: n,
              })})`
          )
          .attr("display", ({ data: t }) =>
            t._directSubordinates > 0 ? null : "none"
          )
        ...
        k.each(r.nodeUpdate);
      const B = w.exit(),
        b = B.data().reduce((t, e) => (t.depth < e.depth ? t : e), {
          depth: 1 / 0,
        });
      B.attr("opacity", 1)
        .transition()
      ...
      if (_) {
        let t = [_];
        _.data._centeredWithDescendants &&
          (t = r.compact
            ? _.descendants().filter((t, e) => e < 7)
            : _.descendants().filter((t, e, n) => {
          ...
          this.fit({ animate: !0, scale: !1, nodes: t });
      }
    }
    isEdge() {
        ...
        t.svg
          ...
          .html(function (e, n, a) {
            return e.data._pagingButton
              ? `<div class="paging-button-wrapper"><div style="pointer-events:none">${t.pagingButton(
                  e,
                  n,
                  a,
                  t
    ...
    onButtonClick(t, e) {
      ...
      e.data._pagingButton ||
        (n.setActiveNodeCentered &&
          ((e.data._centered = !0), (e.data._centeredWithDescendants = !0)),
        e.children
          ? ((e._children = e.children),
            (e.children = null),
            this.setExpansionFlagToChildren(e, !1))
          : ((e.children = e._children),
            (e._children = null),
            e.children &&
              e.children.forEach(({ data: t }) => (t._expanded = !0))),
        this.update(e),
        t.stopPropagation(),
        n.onExpandOrCollapse(e));
    }
    setExpansionFlagToChildren({ data: t, children: e, _children: n }, a) {
      (t._expanded = a),
        e &&
          e.forEach((t) => {
            this.setExpansionFlagToChildren(t, a);
          }),
        n &&
          n.forEach((t) => {
            this.setExpansionFlagToChildren(t, a);
    ...
    expandSomeNodes(t) {
      if (t.data._expanded) {
        let e = t.parent;
        for (; e && e._children; )
          (e.children = e._children), (e._children = null), (e = e.parent);
      }
    ...
    updateNodesState() {
      const t = this.getChartState();
      this.setLayouts({ expandNodesFirst: !0 }), this.update(t.root);
    }
    setLayouts({ expandNodesFirst: t = !0 }) {
      ...
      (e.generateRoot = d
        .stratify()
        .id((t) => e.nodeId(t))
        .parentId((t) => e.parentNodeId(t))),
        (e.root = e.generateRoot(e.data));
      const n = e.root.descendants();
      e.initialExpandLevel > 1 &&
        n.length > 0 &&
        (n.forEach((t) => {
          t.depth <= e.initialExpandLevel && (t.data._expanded = !0);
        }),
        (e.initialExpandLevel = 1));
      const a = {};
      e.root
        ...
        .forEach((t) => {
          t.data._pagingStep = e.minPagingVisibleNodes(t);
        }),
        e.root.eachBefore((t, e) => {
          (t.data._directSubordinatesPaging = t.children
            ? t.children.length
            : 0),
            t.children &&
              t.children.forEach((e, n) => {
                if (
                  ((e.data._pagingButton = !1),
                  n > t.data._pagingStep && (a[e.id] = !0),
                  n === t.data._pagingStep &&
                    t.children.length - 1 > t.data._pagingStep &&
                    (e.data._pagingButton = !0),
                  a[e.parent.id] && (a[e.id] = !0),
                  e.data._expanded ||
                    e.data._centered ||
                    e.data._highlighted ||
                    e.data._upToTheRootHighlighted)
                ) {
                  let t = e;
        ...
        e.root.children &&
          (t && e.root.children.forEach(this.expand),
          e.root.children.forEach((t) => this.collapse(t)),
          0 == e.initialExpandLevel &&
            ((e.root._children = e.root.children), (e.root.children = null)),
    ...
    zoomTreeBounds({
      ...
      y0: n,
      y1: a,
      params: i = { animate: !0, scale: !0, onCompleted: () => {} },
    }) {
      const {
        centerG: o,
        svgWidth: r,
      ...
      let p = Math.min(8, 0.9 / Math.max((e - t) / r, (a - n) / s)),
    ...
    fit({
      ...
      const s = d.min(r, (t) => t.x + i.layoutBindings[i.layout].nodeLeftX(t)),
      ...
      return (
        this.zoomTreeBounds({
          params: { animate: t, scale: n, onCompleted: a },
          x0: s - 50,
          x1: l + 50,
          y0: c - 50,
          y1: h + 50,
    ...
    loadPagingNodes(t) {
      ...
      (t.parent.data._pagingStep = n), this.updateNodesState();
    }
    setExpanded(t, e = !0) {
      const n = this.getChartState(),
      ...
      if (!a)
        return (
          console.log(
            `ORG CHART - ${
              e ? "EXPAND" : "COLLAPSE"
            } - Node with id (${t})  not found in the tree`
          ),
          this
        );
    ...
    setCentered(t) {
      const e = this.getChartState(),
        n = e
          .generateRoot(e.data)
          .descendants()
          .filter(({ data: n }) => e.nodeId(n).toString() == t.toString())[0];
      if (!n)
        return (
          console.log(
            `ORG CHART - CENTER - Node with id (${t}) not found in the tree`
          ),
          this
        );
      return (
        n.ancestors().forEach((t) => (t.data._expanded = !0)),
        (n.data._centered = !0),
        (n.data._expanded = !0),
        this
      );
    ...
    setHighlighted(t) {
      const e = this.getChartState(),
        n = e
          .generateRoot(e.data)
          .descendants()
          .filter((n) => e.nodeId(n.data).toString() === t.toString())[0];
      if (!n)
        return (
          console.log(
            `ORG CHART - HIGHLIGHT - Node with id (${t})  not found in the tree`
          ),
          this
        );
      return (
        n.ancestors().forEach((t) => (t.data._expanded = !0)),
        (n.data._highlighted = !0),
        (n.data._expanded = !0),
        (n.data._centered = !0),
        this
      );
    ...
    setUpToTheRootHighlighted(t) {
      ...
      if (!n)
        return (
          console.log(
            `ORG CHART - HIGHLIGHTROOT - Node with id (${t}) not found in the tree`
          ),
          this
        );
      return (
        n.ancestors().forEach((t) => (t.data._expanded = !0)),
        (n.data._upToTheRootHighlighted = !0),
        (n.data._expanded = !0),
        n.ancestors().forEach((t) => (t.data._upToTheRootHighlighted = !0)),
        this
      );
    }
    clearHighlighting() {
    ...
    fullscreen(t) {
      const e = this.getChartState(),
        n = d.select(t || e.container).node();
      d.select(document).on("fullscreenchange." + e.id, function (t) {
    ...
    exportImg({
      ...
      onLoad: n = (t) => t,
      save: a = !0,
      backgroundColor: i = "#FAFAFA",
    } = {}) {
      const o = this,
        r = this.getChartState(),
        { svg: d, root: s } = r;
      let l = 0;
      const c = d.selectAll("img");
      let h = c.size();
      const g = () => {
        JSON.parse(JSON.stringify(o.lastTransform()));
        const d = o.duration();
        t && o.fit();
        const { svg: l } = o.getChartState();
        setTimeout(
          (t) => {
            o.downloadImage({
              node: l.node(),
    ...
    expandAll() {
      const { allNodes: t, root: e, data: n } = this.getChartState();
      return n.forEach((t) => (t._expanded = !0)), this.render(), this;
    }
    collapseAll() {
      const { allNodes: t, root: e } = this.getChartState();
      return (
        t.forEach((t) => (t.data._expanded = !1)),
    ...
    downloadImage({
      ...
      function c(t) {
        const e = "http://www.w3.org/2000/xmlns/";
        t = t.cloneNode(!0);
        const n = window.location.href + "#",
          a = document.createTreeWalker(t, NodeFilter.SHOW_ELEMENT, null, !1);
        for (; a.nextNode(); )
          for (const t of a.currentNode.attributes)
            t.value.includes(n) && (t.value = t.value.replace(n, "#"));
      ...
      if (a) {
        ...
        return (
          ...
          l(
            (p = "data:image/svg+xml;charset=utf-8," + encodeURIComponent(t)),
            n + ".svg"
          ),
          void r()
        );
      ...
      g.onload = function () {
        ...
        (t.width = e.width * h), (t.height = e.height * h);
